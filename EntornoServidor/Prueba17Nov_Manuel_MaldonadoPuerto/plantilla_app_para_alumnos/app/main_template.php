...
<body>
                ...
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li class="scroll-to-section">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#bookedCoursesModal">
                         My booked courses
                        </button>
                      </li>
                      <!--TO DO: Descomenta este li cuando vayas a gestionar el logout -->
                      <!-- <li class="scroll-to-section">
                        <a href='./logout.php'>
  ...
  <!-- ***** Header Area End ***** -->
  <!-- Modal -->
  <div class="modal fade" id="bookedCoursesModal" tabindex="-1" aria-labelledby="bookedCoursesModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="bookedCoursesModalLabel">Booked courses</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <?php print $booked_courses_markup; ?>
        </div>
...
<div class="toast-container position-fixed bottom-0 end-0 p-3">
  <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
    <div class="toast-header">
      <strong class="me-auto">Scholar</strong>
...
<?php endif; ?>
  ...
  <script src="../public/assets/js/toasts.js"></script>
